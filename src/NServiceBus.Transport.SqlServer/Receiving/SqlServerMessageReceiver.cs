...
class SqlServerMessageReceiver : MessageReceiver
{
    public SqlServerMessageReceiver(SqlServerTransport transport, string receiverId, string receiveAddress,
        ...
        IExpiredMessagesPurger expiredMessagesPurger, Func<ReceiveState, IReceiveWavePolicy> wavePolicyFactory, TimeSpan? headSweepInterval,
        ...
        wavePolicyFactory, headSweepInterval, waitTimeCircuitBreaker, subscriptionManager, purgeAllMessagesOnStartup, exceptionClassifier, timeProvider)
    {
